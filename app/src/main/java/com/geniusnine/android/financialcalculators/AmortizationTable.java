...
public class AmortizationTable extends RecyclerView.Adapter<AmortizationTable.ListViewHolder> {
    ...
    public AmortizationTable(Context context2, ArrayList<Integer> id, ArrayList<Double> amount, ArrayList<Double> interest, ArrayList<Double> principal, ArrayList<Double> remainingbalance) {
        super();
    ...
    public ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View convertView = inflater.inflate(R.layout.list_amortization_table, parent, false);
